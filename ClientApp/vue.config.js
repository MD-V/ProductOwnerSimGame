...
const mockServerPort = 5001 // TODO: get this variable from setting.ts
const name = 'ProductOwnerSimGame' // TODO: get this variable from setting.ts
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API]: {
        target: `https://localhost:${mockServerPort}/api`,
